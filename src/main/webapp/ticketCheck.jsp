<%@page import="teamProject.MovieInfoVO"%>
...
//		let seatNum = document.getElementById('seat').value;
//			
//		seatNum = seatNum.replace(/,\s*$/, ""); //seatNum에 저장된 마지막 콤마 제거
		//인원수 확인
//		let count = 1; 
...
//		    }
//		}
//		document.getElementById("count").innerHTML= count + " 명"; //예매내역의 관람인원 보여주기
//		document.getElementById("seatNum").innerHTML= seatNum //예매내역의 관람좌석번호 보여주기
//		}
	</script>
</head>
  ...
  <div class="ticketWrap">
    ...
    <div class="ticket">
        ...
        <div class="main">
            ...
            <p>관람인원:</p> <span id="count"></span><br>
            <p>관람좌석:</p> <span id="seatNum"></span>
             <input type="hidden" name="seat" id="seat" value="${movieInfoVO.seatNum}">
            
        </div>
    </div>
	 -->
    <div class="btn">
       <button><a href="${contextPath}/index.do">홈으로</a></button> 
    </div>
    <div class="line"></div>
    <div class="note">
        <div>예매 유의사항</div>
